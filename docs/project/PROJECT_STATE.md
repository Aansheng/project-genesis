...
| Architecture Version | v0.51 (Sprint 5) |
| Architecture Status | **Evolving** — Prompt Strategy Consumption (WO-S5-016) complete. Strategy Layer now consumed by Prompt Builder. Selected strategy stored in metadata.promptAssembly.strategy. Phase 0.9 active. No behavior change. |
