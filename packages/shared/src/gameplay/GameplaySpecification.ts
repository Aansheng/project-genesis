...
export const DEFAULT_GAMEPLAY_RULE_PRIMITIVE_CAPABILITIES: readonly GameplayRulePrimitiveCapability[] = Object.freeze([
  ...
  Object.freeze({ id: 'condition-boolean-equals', kind: 'condition' as const, description: 'Compare typed boolean event or entity state against true or false.', status: 'supported' as const }),
